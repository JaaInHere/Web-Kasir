    ...
    <section class="pl-72 px-10 pt-10 pb-10">
        ...
        <form class="max-w-xl pt-5" action="{{ route('update', $produk->produkID) }}" method="POST">
            ...
            <div class="pb-3">
                ...
                <input type="text" id="namaProduk" name="namaProduk" class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500" value="{{ $produk->namaProduk }}">
            </div>
            <div class="pb-3">
                <label for="small-input" class="block mb-2 text-sm font-medium text-gray-900">Harga Produk</label>
                <input type="number" min="0" id="harga" name="harga" class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500" value="{{ $produk->harga }}">
            </div>
            <div class="pb-3">
                <label for="small-input" class="block mb-2 text-sm font-medium text-gray-900">Stok Produk</label>
                <input type="number" min="0" id="stok" name="stok" class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500" value="{{ $produk->stok }}">
            </div>
